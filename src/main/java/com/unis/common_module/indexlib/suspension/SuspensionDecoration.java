package com.unis.common_module.indexlib.suspension;
...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = Color.parseColor("#F6F8FA");
    private static int COLOR_TITLE_BOTTOM_LINE = Color.parseColor("#F6F8FA");
    private static int COLOR_TITLE_FONT = Color.parseColor("#5F6165");
