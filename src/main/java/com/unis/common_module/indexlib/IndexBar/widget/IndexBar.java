package com.unis.common_module.indexlib.IndexBar.widget;
...
import com.unis.common_module.component.CustomLinearLayoutManager;
import com.unis.common_module.indexlib.IndexBar.bean.BaseIndexPinyinBean;
import com.unis.common_module.indexlib.IndexBar.helper.IIndexBarDataHelper;
import com.unis.common_module.indexlib.IndexBar.helper.IndexBarDataHelperImpl;
...
public class IndexBar extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint.setColor(context.getResources().getColor(R.color.gray_5F));
        //设置index触摸监听器
