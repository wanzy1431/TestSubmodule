...
public class HeaderLayout extends RelativeLayout {
    ...
    private static final int TYPE_HEADER_BLACK = 7;
    ...
    private void setHeaderLayout(Context context, int layoutResourceId, int type) {
        switch (type) {
            ...
            case TYPE_HEADER:
                addHeaderBar();
                break;
            case TYPE_HEADER_BLACK:
                addHeaderBar();
                headerHolder.statusbar.setBackgroundColor(getResources().getColor(R.color.black_2A));
                headerHolder.view.setBackgroundColor(getResources().getColor(R.color.black_2A));
                headerHolder.ivCommonLeft.setBackgroundResource(R.mipmap.white_back);
                break;
            ...
            case TYPE_BLUE_HEADER:
                ...
                headerHolder.view.setBackgroundResource(R.mipmap.header_top_bg);
                headerHolder.ivCommonLeft.setBackgroundResource(R.mipmap.ic_left_white);
...
//        params.addRule(RelativeLayout.ALIGN_PARENT_TOP);
        //
        headerHolder.tvCommonRight2.setOnClickListener(new NoDoubleClickListener() {
            @Override
            protected void onNoDoubleClick(View v) {
                if (null != mListener) mListener.onClickCommonRight();
            }
        });
    ...
    public void setIvRight2(int imageRes) {
        headerHolder.ivRight2.setVisibility(VISIBLE);
        headerHolder.ivRight2.setImageResource(imageRes);
    }
    ...
    public void setHeaderBarAndRightTv(String titleText, String right) {
        ...
        if (!StringUnisUtil.isEmpty(right)) {
    ...
    public TextView getRightTextView() {
        return headerHolder.tvCommonRight;
    }
    ...
    public void showLoadingPage() {
        showLoadingPage(StringUnisUtil.getResString(R.string.loading));
    }
    ...
    public void showErrorPage() {
        showErrorPage(R.mipmap.net_error, StringUnisUtil.getResString(R.string.net_error));
    }
    ...
    public void showErrorPage(int imgResID, String errorText) {
        if (null != progressPageView) {
            ...
            if (!StringUnisUtil.isNullOrEmpty(errorText)) {
    ...
    public void showNoDatasPage() {
        showNoDatasPage(R.mipmap.ic_nodata, StringUnisUtil.getResString(R.string.nodata));
    }
    ...
    public void showNoDatasPage(int imgResID, String noDatasText) {
        if (null != progressPageView) {
            ...
            if (!StringUnisUtil.isNullOrEmpty(noDatasText)) {
    ...
    public class HeaderHolder extends BaseHolder {
        ...
        @OnClick({R2.id.ll_common_left, R2.id.tv_common_right, R2.id.iv_qr, R2.id.ll_close, R2.id.rl_icon_right, R2.id.tv_bg_right, R2.id.iv_refresh, R2.id.iv_right2})
...
//            else if (i == R.id.tv_common_right2) {
//                if (null != mListener) mListener.onClickCommonRight();
//            }
            else if (i == R.id.iv_right2) {
                if (null != mListener) mListener.onClickCommonRight2();
            }
