package com.unis.module_msg.widget;
...
public class PageIndicator implements ViewPager.OnPageChangeListener {
    ...
    private OnSelectIndicator onSelectIndicator;

    public void setOnSelectIndicator(OnSelectIndicator onSelectIndicator) {
        this.onSelectIndicator = onSelectIndicator;
    }
        ...
        for (int i = 0; i < mPageCount; i++) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onSelectIndicator != null) {
                        onSelectIndicator.onSelectIndicator(index);
                    }
                }
            });
