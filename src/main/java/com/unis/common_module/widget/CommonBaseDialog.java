...
public class CommonBaseDialog extends Dialog implements View.OnClickListener {
    ...
    public static CommonBaseDialog showDialog(Context mContext, int itemLayoutId) {
        CommonBaseDialog dialog = new CommonBaseDialog(mContext, R.style.base_dialog, itemLayoutId);
        dialog.show();
        return dialog;
    }

    public static CommonBaseDialog showExitDialog(Context mContext, int itemLayoutId) {
        CommonBaseDialog dialog = new CommonBaseDialog(mContext, R.style.base_dialog, itemLayoutId);
