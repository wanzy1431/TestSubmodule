...
import com.unis.common_module.widget.combinebitmap.layout.DingLayoutManager;
import com.unis.common_module.widget.combinebitmap.layout.ILayoutManager;
import com.unis.common_module.widget.combinebitmap.layout.WechatLayoutManager;
import com.unis.common_module.widget.combinebitmap.listener.OnProgressListener;
import com.unis.common_module.widget.combinebitmap.listener.OnSubItemClickListener;
import com.unis.common_module.widget.combinebitmap.region.DingRegionManager;
import com.unis.common_module.widget.combinebitmap.region.IRegionManager;
import com.unis.common_module.widget.combinebitmap.region.WechatRegionManager;
...
public class Builder {
    ...
    public int placeholder = R.mipmap.default_head; // 获取图片失败时的默认图片
