package com.unis.common_module.utils.permission;
...
public class RxPermissionsFragment extends Fragment {
    ...
    void onRequestPermissionsResult(String[] permissions, int[] grantResults, boolean[] shouldShowRequestPermissionRationale) {
        for (int i = 0, size = permissions.length; i < size; i++) {
            ...
            if (subject == null) {
                // No subject found
                LogUtil.e(RxPermissions.TAG + "：RxPermissions.onRequestPermissionsResult invoked but didn't find the corresponding permission request.");
                return;
            }
    ...
    void log(String message) {
        if (mLogging) {
            LogUtil.e(RxPermissions.TAG + "：" + message);
        }
    }
