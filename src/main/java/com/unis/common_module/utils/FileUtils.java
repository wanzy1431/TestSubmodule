...
public class FileUtils {
    ...
    public static String getCachePath() {
        File f = AppContextUtil.getContext().getCacheDir();
        if (null == f) {
            return null;
        } else {
    ...
    public static boolean isWriteable(String path) {
        try {
            if (StringUnisUtil.isEmpty(path)) {
                return false;
            }
    ...
    public static void writeProperties(String filePath, String key, String value, String comment) {
        if (StringUnisUtil.isEmpty(key) || StringUnisUtil.isEmpty(filePath)) {
            return;
        }
    ...
    public static void writeMap(String filePath, Map<String, String> map, boolean append, String comment) {
        if (map == null || map.size() == 0 || StringUnisUtil.isEmpty(filePath)) {
            return;
        }
        FileInputStream fis = null;
        FileOutputStream fos = null;
    ...
    public static Map<String, String> readMap(String filePath, String defaultValue) {
        if (StringUnisUtil.isEmpty(filePath)) {
            return null;
        }
